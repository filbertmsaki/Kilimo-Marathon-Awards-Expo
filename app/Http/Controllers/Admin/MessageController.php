...
use App\Models\Message\Participant;
...
class MessageController extends Controller
{
    ...
    public function index()
    {
        ...
        DB::enableQueryLog();
        // dd(DB::getQueryLog());
        $threads = Thread::forUser(auth()->user()->id)->latest('updated_at')->paginate(10);
        $participants = Participant::where('user_id', auth()->id())->whereNull('deleted_at')->get();
