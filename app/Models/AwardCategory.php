...
class AwardCategory extends Model
{
    ...
    public function scopeNominees(Builder $query){
        ...
        ->groupBy('award_categories.id','award_categories.slug',
        'award_categories.name','award_categories.name_in_swahili','award_categories.description','award_categories.created_at','award_categories.updated_at',)
