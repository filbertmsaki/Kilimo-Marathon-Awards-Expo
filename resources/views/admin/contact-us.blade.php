                        ...
                        <div class="card">
                            <div class="card-header">
                                <button style="margin-bottom: 10px" type="submit" class="btn btn-primary delete_all"
                                    formaction="{{ route('admin.contact_us.delete_all') }}">Delete Selected
                                    Contact</button>
                                    ...
                                    <tbody>
                                        @foreach ($contact_us as $contact)
                                            <tr id="contact_id_{{ $contact->id }}">
                                                <td><input type="checkbox" name="contact_id[]" value="{{ $contact->id }}"
                                                        id="sub_chk_{{ $contact->id }}" class="sub_chk"></td>
                                                ...
                                                <td class="">
                                                    <a href="javascript:void(0)" id="view-contact"
                                                        style="margin-right: 5px;" class="fa fa-edit view-contact"
                                                        data-id="{{ $contact->id }}" data-toggle="tooltip"
                                                        data-placement="top" title="Edit"></a>
                                                    <a href="{{ route('admin.contact_us.delete', $contact->id) }}"
                                                        id="delete-contact" class=" delete-contact fa fa-trash "
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('admin.contact_us.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <button type="submit" name="contact-bt" value=""
                                    class="btn btn-outline-light btn-save">Seen</button>
                            </div>
                        </form>
                    </div>
