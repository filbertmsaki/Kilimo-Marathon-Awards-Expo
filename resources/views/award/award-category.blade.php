...
<head>
    ...
    <title>
        Awards Category Vote | Kilimo Marathon, Awards & EXPO
    </title>
    ...
    <section id="team" class="image-background">
        ...
        <div class="container" style="min-height:300px;">
            <h1 class="section-title wow fadeInUpQuick animated" data-wow-delay=".5s" style="color:#fff;visibility: visible;-webkit-animation-delay: .5s; -moz-animation-delay: .5s; animation-delay: .5s;">
                <p style="color:#ffffff;"> Kilimo Awards Nominees Voting </p>
            </h1>
                    ...
                    <div class="col-md-3 col-sm-6 col-6 list-item ">
                        <div class="info-box">
                            <div class="info-box-content">
                                <span class="info-box-header">{{ $nominee->awardcategory->name }}</span>
                                <span class="info-box-desc">{{ $nominee->total_nominee }} Nominees</span>
                                <div class="info-box-bar">
                                    <div class="info-box-bar-line"></div>
                                </div>
                                <div class="info-box-footer">
                                    <a href="{{ route('votes_nominees',$nominee->awardcategory->slug) }}" class="small-box-footer">
