        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <a href="{{ route('index') }}" class="mt-30 btn btn-outline btn-lg"><i class="fa fa-home"></i>
                        GET BACK HOME</a>
                </div>
            </div>
        </div>
            ...
            <div class="row section">
                <div class="footer-widget col-md-6 col-lg-4 col-xs-12">
                    ...
                    <p>
                        ...
                        sector in general for the aim of helping us realizing our main goal which reveals tangible
                ...
                <div class="footer-widget col-md-6 col-lg-4 col-xs-12">
                    ...
                    <ul class="mb-3">
                        <li><i class="fa fa-map-marker-alt"></i> Mkulima House, 2nd Floor - Mandela Rd, Ubungo Dar es
                            salaam </li>
