...
<h1>503</h1>
<h4>Opps!Service Unavailable</h4>
<a href="{{ route('index') }}" class="mt-30 btn btn-outline btn-lg"><i class="fa fa-home"></i> GET BACK HOME</a>
</div>
</div>
</div>
</section>
...
<footer>
    ...
    <li><a href="#">Marathons & Mission</a></li>
    <li><a href="#">History of Our Marathon Team</a></li>
    <li><a href="#">Schedule of Our Training</a></li>
    ...
    <ul class="mb-3">
        <li><i class="fa fa-map-marker-alt"></i> Mkulima House, 2nd Floor - Mandela Rd, Ubungo Dar es salaam </li>
        <li><i class="fa fa-phone"></i> +255 754 222 800</li>
    ...
    <p class="copyright-text">Designed and Developed by <a href="https://ric.co.tz/" rel="nofollow">RIC</a></p>
    </div>
    <div class="col-md-6 col-sm-6">
