    ...
    <div id="myCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img src="{{ asset('images-s/marathon-1.jpg') }}" class="d-block " alt="Kilimo Marathon">
                @elseif ($page == 'kilimo_award')
                <img src="{{ asset('images-s/IMG_6837.jpg') }}" class="d-block " alt="Kilimo Award">
                @elseif ($page == 'kilimo_expo')
                <img src="{{ asset('images-s/IMG_5273.jpg') }}" class="d-block " alt="Kilimo Expo">
                @endif
            </div>
        </div>
    </div>
