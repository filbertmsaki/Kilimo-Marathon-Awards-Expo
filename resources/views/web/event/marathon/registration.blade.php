                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-select select2" name="event" required>
                                                ...
                                                <option value="5"
                                                    @if (old('event') == '5') selected @endif>5
                                                    Km
                                                </option>
                                                <option value="10"
                                                    @if (old('event') == '10') selected @endif>
                                                    10 Km
                                                </option>
                                                <option value="21"
                                                    @if (old('event') == '21') selected @endif>
                                                    21 Km
                                                </option>
                                                <option value="cycling"
                                                    @if (old('event') == 'cycling') selected @endif>
                                                    Cycling 100 km
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-select select2" name="t_shirt_size">
                                                ...
                                                <option value="S"
                                                    @if (old('t_shirt_size') == 'S') selected @endif>S
                                                    Size
                                                </option>
                                                <option value="M"
                                                    @if (old('t_shirt_size') == 'M') selected @endif>
                                                    M Size
                                                </option>
                                                <option value="L"
                                                    @if (old('t_shirt_size') == 'L') selected @endif>
                                                    L Size
                                                </option>
                                                <option value="XL"
                                                    @if (old('t_shirt_size') == 'XL') selected @endif>
                                                    XL
                                                </option>
                                                <option value="XXL"
                                                    @if (old('t_shirt_size') == 'XXL') selected @endif>
                                                    XXL
                                                </option>
                                            </select>
                                        </div>
